...
func getZById(pub *PublicKey, id []byte) []byte {
	...
	/* The return value in getZByID is []byte
	 * but return value in sm3.SumSM3 is [32]byte
	 * this is the reason why we need a copy behavior here
	 * moreover return value of sm3.SumSM3 is same to SumSHA256
